...
![image](https://user-images.githubusercontent.com/32366711/128202940-4ce0b611-80f1-4af1-9b5a-26f759e1743e.png){: width="500"}{: .aligncenter}

데이터를 최대한 보존한다는 뜻은 오차의 합이 최소가 되도록 한다는 뜻

즉 직선과 데이터간의 오차의 합@\sum \limits_ {i=1}^{n} b_ i ^2@이 최소가 되도록 하려고 함
