...
WHERE P.Plocation='Stafford' AND P.Dnum = D.Dnumber AND D.MGR_ SSN = E.SSN;

~~~

@
\pi _ {\text{Pnumber, Dnum, Lname, Address, date}} (((\sigma_ {\text{Plocation} = \text{'Stafford'}} \text{PROJECT}) \Join_ {\text{Dnum = Dnumber}} \text{DEPARTMENT}) \Join _ {\text{MGR_ SSN = SSN}} \text{EMPLOYEE} )
@


![image](https://user-images.githubusercontent.com/32366711/136659099-342b7d68-a3c8-418e-98df-21087b5bb6ea.png)
