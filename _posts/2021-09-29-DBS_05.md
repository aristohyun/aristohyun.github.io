...
$
FEMALE\_ EMPS \leftarrow \sigma_ {SEX='F'}(EMPLOYEE) \\\ 
EMPNAMES \leftarrow \pi_ {FNAME, LNAME, SSN}(FEMALE_ EMPS) \\\ 
EMP\_ DEPENDENTS \leftarrow EMPNAMES \times DEPENDENT \\\ 
ACTUAL\_ {DEPS} \leftarrow \sigma_ {SSN=ESSN}(EMP\_ DEPENDENTS) \\\ 
RESULT \leftarrow \pi_ {FNAME, LNAME, DEPENDENT\_ NAME}(ACTUAL\_ DEPS)
$
...
$
RESULT \leftarrow EMPLOYEE \Join _ {SEX='f' AND SSN = ESSN} DEPENDENT
$
...
![image](https://user-images.githubusercontent.com/32366711/136653645-f99316ed-998c-4a9f-9c21-8e6ce04fe46d.png){: .aligncenter}{: width="300"}
...
![image](https://user-images.githubusercontent.com/32366711/136653656-04f81e50-8bf2-4621-a318-f91f0c75dba2.png){: .aligncenter}{: width="300"}
...
- 왼쪽 테이블의 row를 유지하면 Left Outer Join
- 오른쪽 테이블의 row를 유지하면 Right Outer Join
- 양쪽 테이블의 row를 모두 유지하면 Full Outer Join

![image](https://user-images.githubusercontent.com/32366711/136653766-3a31aece-02e1-44c4-8dd8-ec8a65c3083e.png){: .aligncenter}{: width="300"}
...
![image](https://user-images.githubusercontent.com/32366711/136653784-8e6cd402-b6c8-44f8-81a8-7ddcf8c3cfa8.png){: .aligncenter}{: width="300"}
...
![image](https://user-images.githubusercontent.com/32366711/136653780-528eb83b-47b0-4949-9be8-6813549914dd.png){: .aligncenter}{: width="300"}
...
![image](https://user-images.githubusercontent.com/32366711/136653791-27e180bc-08b5-4041-b1b5-eb08001edc07.png){: .aligncenter}{: width="300"}
...
[^algebra]: ![image](https://user-images.githubusercontent.com/32366711/136653974-9da260e6-6149-4b47-a155-ac677b6b8f11.png)
