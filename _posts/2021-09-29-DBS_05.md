...
@
\mathfrak{I}_ {\text{SUM Salary}}
@

#### AVERAGE

@
\mathfrak{I}_ {\text{AVERAGE Salary}}
@

#### MAXIMUM

@
\mathfrak{I}_ {\text{MAX Salary}}
@

#### MINIMUM

@
\mathfrak{I}_ {\text{MIN Salary}}
@

#### COUNT

@
\mathfrak{I}_ {\text{COUNT Salary}}
@
...
\text{PRJ_STAFFORD_DEPARTMENT} \leftarrow \text{PROJECT_STAFFORD} \Join _ {Dnum = Dnumber} \text{DEPARTMENT} \\\ 
\text{RESULT} \leftarrow \pi _ {\text{Pname, Dnumber, Lname, Address, Bdate}} (\text{EMPLOYEE} \Join _ {SSN = Mgr_ssn} \text{PRJ_STAFFORD_DEPARTMENT}) 
@
...
> Make a list of project numbers for projects thar involve an employee whose last name is 'Smith',              
