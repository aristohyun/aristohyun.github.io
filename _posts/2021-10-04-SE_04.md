...
| Requirements Gathering | RDD | - 시스템 설명 <br/> - 기능 요구사항 <br/> - 비기능적 요구사항 | |
| Requirements Analysis  | SRS | - 기능 분석 모델 <br/> - 데이터 모델  | |
| Design                 | SDD | - 예비 설계 <br/> - 상세 설계 <br/>  - 전개 | Separated in some case |
