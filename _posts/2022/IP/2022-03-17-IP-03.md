...
- brightness characteristics -> brightness histogram
- spatial frequency characteristics -> spatial frequency transform
...
푸리에 변환(FT), 이산 코사인 변환(DCT), 웨이블릿 변환(WT)  등등
