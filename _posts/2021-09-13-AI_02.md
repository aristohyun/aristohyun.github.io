...
\begin{align\*}
 ...
 &= \frac{1}{2}(x_ 1 ^ 2 + x_ 2 ^ 2) + \lambda (1-x_ 1-x_ 2) + \alpha (\frac{3}{4} - x^2) \;\;\; (\alpha \geq 0) 
\end{align\*}
@
 
`등식 제약 조건이 만족하는 것 중에서 선택하게 됨`

1. $ \usepackage{xcolor} min_ {x_ 1, x_ 2} max_ \lambda \lambda g (x_ 1, x_ 2)$의 값은 $ \[ \textcolor{red}{g(x_ 1, x_ 2) = 0} \] $         
2. $ min_ {x_ 1, x_ 2} max_ {\alpha \geq} \alpha h (x_ 1, x_ 2)$의 값은 \[ $\textcolor{red}{h(x_ 1, x_ 2) \leq 0} \]$                
...
@
 \begin{align\*}
 L_ d (\lambda, \alpha) &= min_ {x_ 1, x_ 2}L(x_ 1, x_ 2, \lambda, \alpha) \\\ 
 & \frac {\partial L(x_ 1, x_ 2, \lambda, \alpha) }{\partial x_ 1 } = x_ 1 - \lambda = 0 \;\;\;\; x_ 1 = \lambda \\\ 
 & \frac {\partial L(x_ 1, x_ 2, \lambda, \alpha) }{\partial x_ 2 } = x_ 2 - \lambda - \alpha = 0 \;\;\;\; x_ 2 = \lambda + \alpha \\\ 
