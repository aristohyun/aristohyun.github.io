...
> Galton이 부모와 자식의 키에 대한 조사를 하며 이를 그래프로 그려보았더니, 부모의 키와 유사한 경향을 보였으며, 자식들의 키는 평균으로 회귀하고 있음을 찾아내었다       
> 그러나, 이 때는 회귀분석이 적합하는 선을 결정하는 통계적 절차를 의미하는 것이 아니었으며, 최소제곱법을 통해 회귀선을 구한 것 또한 아니었다      
