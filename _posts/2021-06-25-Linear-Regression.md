...
$ \sum\limits_ {i=1}^{n} (y_ i - \hat{y}_ i) x_ {ki} = 0 \\\ 
\sum\limits_ {i=1}^{n} (y_ i - \hat{y}_ i) x_ {1i} + \sum\limits_ {i=1}^{n} (y_ i - \hat{y}_ i) x_ {2i} + \ctods + \sum\limits_ {i=1}^{n} (y_ i - \hat{y}_ i) x_ {ni} \\\ 
