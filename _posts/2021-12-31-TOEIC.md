...
<div class="multi-stage">
  <div class="stage">
    <ul>
      <li>[^11-1]demanding task</li>
      <li>[^11-2]missing luggage</li>
      <li>[^11-3]rewarding job</li>
      <li>[^11-4]existing facility</li>
    </ul>
    </div>
    <div class="stage">
    <ul>
      <li>[^11-5]outstanding speaker</li>
      <li>[^11-6]upcomming festival</li>
      <li>[^11-7]lasting effect</li>
      <li>[^11-8]remaining work</li>
  </ul>
  </div>
</div>
